...
const trans1 = (x, y) => `translate3d(${x / 7 - 180}px,${y / 8 - 0}px,0)`
const trans2 = (x, y) => `translate3d(${x / 7 + 120}px,${y / 10 - 260}px,0)`
const trans3 = (x, y) => `translate3d(${x / 8 - 60}px,${y / 9 - 200}px,0)`
const trans4 = (x, y) => `translate3d(${x / 6 + 80}px,${y / 9 + 80}px,0)`
const trans5 = (x, y) => `translate3d(${x / 8 - 120}px,${y / 7 + 160}px,0)`
const trans6 = (x, y) => `translate3d(${x / 6 - 0}px,${y / 6 - 80}px,0)`
const trans7 = (x, y) => `translate3d(${x / 8 + 100}px,${y / 7 + 240}px,0)`
const trans8 = (x, y) => `translate3d(${x / 9 + 280}px,${y / 10 - 220}px,0)`
const trans9 = (x, y) => `translate3d(${x / 8 + 340}px,${y / 8 - 40}px,0)`
const trans10 = (x, y) => `translate3d(${x / 7 + 280}px,${y / 7 + 160}px,0)`
const trans11 = (x, y) => `translate3d(${x / 7 + 190}px,${y / 7 - 100}px,0)`
